...
public class RCC_Demo : MonoBehaviour {
    ...
    internal int selectedVehicleIndex = 0;      // An integer index value used to spawn a new vehicle.
    internal int selectedBehaviorIndex = 0;     // An integer index value used to set a new behavior mode.
